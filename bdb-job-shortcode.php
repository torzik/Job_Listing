<?php
function bdb_job_taxonomy_list( $atts, $content = null ) {
    $atts = shortcode_atts( 
        array(
...
add_shortcode( 'job_location_list', "bdb_job_taxonomy_list" );

function bdb_list_job_by_location( $atts, $content = null ) {
...
add_shortcode( 'jobs_by_location', 'bdb_list_job_by_location' );